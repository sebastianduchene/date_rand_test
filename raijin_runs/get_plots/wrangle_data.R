...
dat4 <- dat4[, 1:36]
dat5 <- read.table('compiled_5_2.txt', as.is = T)
dat5 <- dat5[, 1:36]
dat6 <- read.table('compiled_6_2.txt', as.is = T)
dat_comp <- rbind(dat4, dat5, dat6)


vsites4 <- read.table('var_sites_mat_IV.txt', head = T, as.is = T)
vsites5 <- read.table('var_sites_mat_V.txt', head = T, as.is = T)
vsites6 <- read.table('var_sites_mat_6_2.txt', head = T, as.is = T)
vsites_comp <- rbind(vsites4, vsites5, vsites6)

dat <- merge(dat_comp, vsites_comp, by.x = 1, by.y = 1)
...
plot_lvar_high <- ggplot(d_lvar_high, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point(aes(shape = pass_label), size = 4) + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE, shape = FALSE) + scale_colour_manual(values = c('grey', 'black')) + theme_bw() + ylab('') + xlab('')+ annotate('text', x = c(0.8, 0.8), y = c(-2.2, -2.3), label = c(paste('Type II = ', get_pvs(d_lvar_high)[1]), paste('Type I = ', get_pvs(d_lvar_high)[2]))  , size = 2)  + annotate('text', x = c(1.25, 1.25), y = c(-2.2, -2.3), label = c(paste('Type II = ', get_pvs(d_lvar_high)[3]), paste('Type I = ', get_pvs(d_lvar_high)[4]))  , size = 2)  + geom_hline(y = log10(0.001 * 1.05), linetype = 2) + geom_hline(y = log10(0.001 / 1.05), linetype = 2)# + annotate('text', x = c(1.25, 1.25), y = c(-2.35, -2.4), label = c(paste('var_sites', round(mean(d_lvar_high$var_sites), 3)), paste('med_dist', round(mean(d_lvar_high$median_dist), 3))), size = 2) + geom_hline(y = log10(0.01 * 1.05), linetype = 2) + geom_hline(y = log10(0.01 / 1.05), linetype = 2)

plot_lvar_med <- ggplot(d_lvar_med, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point(aes(shape = pass_label), size = 4) + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0005))) + guides(colour = FALSE, shape = FALSE) + scale_colour_manual(values = c('grey', 'black')) + theme_bw() + ylab('') + xlab('') + annotate('text', x = c(0.8, 0.8), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_lvar_med)[1]), paste('Type I = ', get_pvs(d_lvar_med)[2])) , size = 2)  + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_lvar_med)[3]), paste('Type I = ', get_pvs(d_lvar_med)[4])) , size = 2)  + geom_hline(y = log10(0.0005 * 1.05), linetype = 2) + geom_hline(y = log10(0.0005 /1.05), linetype = 2)#+ annotate('text', x = c(1.25, 1.25), y = c(-2.55, -2.6), label = c(paste('var_sites', round(mean(d_lvar_med$var_sites), 3)), paste('med_dist', round(mean(d_lvar_med$median_dist), 3))), size = 2) + geom_hline(y = log10(0.001 * 1.05), linetype = 2) + geom_hline(y = log10(0.001 /1.05), linetype = 2)

plot_lvar_low <- ggplot(d_lvar_low, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point(aes(shape = pass_label), size = 4) + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE, shape = FALSE) + scale_colour_manual(values = c('grey', 'black')) + theme_bw() + ylab('') + xlab('')+ annotate('text', x = c(0.8, 0.8), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_lvar_low)[1]), paste('Type I = ', get_pvs(d_lvar_low)[2])) , size = 2)  + annotate('text', x = c(1.3, 1.3), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_lvar_low)[3]), paste('Type I = ', get_pvs(d_lvar_low)[4])) , size = 2)  + geom_hline(y = log10(0.0001 * 1.05), linetype = 2) + geom_hline(y = log10(0.0001 / 1.05), linetype = 2)#+ annotate('text', x = c(1.25, 1.25), y = c(-2.55, -2.6), label = c(paste('var_sites', round(mean(d_lvar_low$var_sites), 3)), paste('med_dist', round(mean(d_lvar_low$median_dist), 3))), size = 2) + geom_hline(y = log10(0.0001 * 1.05), linetype = 2) + geom_hline(y = log10(0.0001 / 1.05), linetype = 2)
...
plot_hvar_high <- ggplot(d_hvar_high, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point(aes(shape = pass_label), size = 4) + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE, shape = FALSE) + scale_colour_manual(values = c('grey', 'black')) + theme_bw() + ylab('') + xlab('')+ annotate('text', x = c(0.8, 0.8), y = c(-2.2, -2.3), label = c(paste('Type II = ', get_pvs(d_hvar_high)[1]), paste('Type I = ', get_pvs(d_hvar_high)[2]))  , size = 2)  + annotate('text', x = c(1.25, 1.25), y = c(-2.2, -2.3), label = c(paste('Type II = ', get_pvs(d_hvar_high)[3]), paste('Type I = ', get_pvs(d_hvar_high)[4]))  , size = 2)   + geom_hline(y = log10(0.001 * 1.2), linetype = 2) + geom_hline(y = log10(0.001 / 1.2), linetype = 2)#+ annotate('text', x = c(1.25, 1.25), y = c(-2.35, -2.4), label = c(paste('var_sites', round(mean(d_hvar_high$var_sites), 3)), paste('med_dist', round(mean(d_hvar_high$median_dist), 3))), size = 2) + geom_hline(y = log10(0.01 * 1.2), linetype = 2) + geom_hline(y = log10(0.01 / 1.2), linetype = 2)

plot_hvar_med <- ggplot(d_hvar_med, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point(aes(shape = pass_label), size = 4) + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0005))) + guides(colour = FALSE, shape = FALSE) + scale_colour_manual(values = c('grey', 'black')) + theme_bw() + ylab('') + xlab('') + annotate('text', x = c(0.8, 0.8), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_hvar_med)[1]), paste('Type I = ', get_pvs(d_hvar_med)[2])) , size = 2)  + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_hvar_med)[3]), paste('Type I = ', get_pvs(d_hvar_med)[4])) , size = 2)  + geom_hline(y = log10(0.0005 * 1.2), linetype = 2) + geom_hline(y = log10(0.0005 / 1.2), linetype = 2)#+ annotate('text', x = c(1.25, 1.25), y = c(-2.55, -2.6), label = c(paste('var_sites', round(mean(d_hvar_med$var_sites), 3)), paste('med_dist', round(mean(d_hvar_med$median_dist), 3))), size = 2) + geom_hline(y = log10(0.001 * 1.2), linetype = 2) + geom_hline(y = log10(0.001 / 1.2), linetype = 2)

plot_hvar_low <- ggplot(d_hvar_low, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point(aes(shape = pass_label), size = 4) + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE, shape = FALSE) + scale_colour_manual(values = c('grey', 'black')) + theme_bw() + ylab('') + xlab('')+ annotate('text', x = c(0.8, 0.8), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_hvar_low)[1]), paste('Type I = ', get_pvs(d_hvar_low)[2])) , size = 2)  + annotate('text', x = c(1.3, 1.3), y = c(-2.4, -2.5), label = c(paste('Type II = ', get_pvs(d_hvar_low)[3]), paste('Type I = ', get_pvs(d_hvar_low)[4])) , size = 2)  + geom_hline(y = log10(0.0001 * 1.2), linetype = 2) + geom_hline(y = log10(0.0001 / 1.2), linetype = 2)#+ annotate('text', x = c(1.25, 1.25), y = c(-2.55, -2.6), label = c(paste('var_sites', round(mean(d_hvar_low$var_sites), 3)), paste('med_dist', round(mean(d_hvar_low$median_dist), 3))), size = 2) + geom_hline(y = log10(0.0001 * 1.2), linetype = 2) + geom_hline(y = log10(0.0001 / 1.2), linetype = 2)
