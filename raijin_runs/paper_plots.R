...
plot_clock_high_cr1 <- ggplot(d_clock_high, aes(x = cal_time, y = rate_mean, colour = pass_cr1)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.01))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + xlab('') + ylab('') + annotate('text', x = c(1.25, 1.25), y = c(-2.2, -2.3), label = c(paste('PPV = ', get_pvs(d_clock_high)[1]), paste('NPV = ', get_pvs(d_clock_high)[2]))  , size = 2) 



plot_clock_high_cr2 <- ggplot(d_clock_high, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.01))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + ylab('') + xlab('') + annotate('text', x = c(1.25, 1.25), y = c(-2.2, -2.3), label = c(paste('PPV = ', get_pvs(d_clock_high)[3]), paste('NPV = ', get_pvs(d_clock_high)[4]))  , size = 2) 
...
plot_clock_med_cr1 <- ggplot(d_clock_med, aes(x = cal_time, y = rate_mean, colour = pass_cr1)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE) + scale_colour_manual(values = c('black', 'red')) + theme_bw()+ylab('') + xlab('') + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_clock_med)[1]), paste('NPV = ', get_pvs(d_clock_med)[2]))  , size = 2) 

plot_clock_med_cr2 <- ggplot(d_clock_med, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + ylab('') + xlab('') + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_clock_med)[3]), paste('NPV = ', get_pvs(d_clock_med)[4])) , size = 2) 
...
plot_clock_low_cr1 <- ggplot(d_clock_low, aes(x = cal_time, y = rate_mean, colour = pass_cr1)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + xlab(expression(paste(Log[10], ' Rate', ' (subst/site/year)' ))) + ylab('')  + annotate('text', x = c(1.2, 1.2), y = c(-3, -3.2), label = c(paste('PPV = ', get_pvs(d_clock_low)[1]), paste('NPV = ', get_pvs(d_clock_low)[2])) , size = 2) 

plot_clock_low_cr2 <- ggplot(d_clock_low, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + ylab('') + xlab('') + annotate('text', x = c(1.2, 1.2), y = c(-3, -3.2), label = c(paste('PPV = ', get_pvs(d_clock_low)[3]), paste('NPV = ', get_pvs(d_clock_low)[4])) , size = 2) 
...
plot_lvar_med_cr1 <- ggplot(d_lvar_med, aes(x = cal_time, y = rate_mean, colour = pass_cr1)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE) + scale_colour_manual(values = c('black', 'red')) + theme_bw()+ylab('') + xlab('')  + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_lvar_med)[1]), paste('NPV = ', get_pvs(d_lvar_med)[2]))  , size = 2) 

plot_lvar_med_cr2 <- ggplot(d_lvar_med, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + ylab('') + xlab('')  + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_lvar_med)[3]), paste('NPV = ', get_pvs(d_lvar_med)[4]))  , size = 2) 
...
plot_lvar_low_cr1 <- ggplot(d_lvar_low, aes(x = cal_time, y = rate_mean, colour = pass_cr1)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE) + scale_colour_manual(values = c('black', 'red')) + theme_bw() + xlab(expression(paste(Log[10], ' Rate', ' (subst/site/year)' ))) + ylab('')  + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_lvar_low)[1]), paste('NPV = ', get_pvs(d_lvar_low)[2]))  , size = 2) 

plot_lvar_low_cr2 <- ggplot(d_lvar_low, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + ylab('') + xlab('')  + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_lvar_low)[3]), paste('NPV = ', get_pvs(d_lvar_low)[4]))  , size = 2) 
...
plot_hvar_med_cr1 <- ggplot(d_hvar_med, aes(x = cal_time, y = rate_mean, colour = pass_cr1)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE) + scale_colour_manual(values = c('black', 'red')) + theme_bw()+ylab('') + xlab('') + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_hvar_med)[1]), paste('NPV = ', get_pvs(d_hvar_med)[2]))  , size = 2) 

plot_hvar_med_cr2 <- ggplot(d_hvar_med, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.001))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + ylab('') + xlab('') + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_hvar_med)[3]), paste('NPV = ', get_pvs(d_hvar_med)[4]))  , size = 2) 
...
plot_hvar_low_cr1 <- ggplot(d_hvar_low, aes(x = cal_time, y = rate_mean, colour = pass_cr1)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE) + scale_colour_manual(values = c('black', 'red')) + theme_bw() + xlab(expression(paste(Log[10], ' Rate', ' (subst/site/year)' ))) + ylab('') + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_hvar_low)[1]), paste('NPV = ', get_pvs(d_hvar_low)[2]))  , size = 2) 

plot_hvar_low_cr2 <- ggplot(d_hvar_low, aes(x = cal_time, y = rate_mean, colour = pass_cr2)) + geom_point() + geom_errorbar(aes(ymin = rate_low, ymax = rate_high)) + geom_hline(aes(yintercept = log10(0.0001))) + guides(colour = FALSE) + scale_colour_manual(values = c('red', 'black')) + theme_bw() + ylab('') + xlab('') + annotate('text', x = c(1.2, 1.2), y = c(-2.4, -2.5), label = c(paste('PPV = ', get_pvs(d_hvar_low)[3]), paste('NPV = ', get_pvs(d_hvar_low)[4]))  , size = 2) 
