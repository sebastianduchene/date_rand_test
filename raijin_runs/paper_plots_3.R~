...
dat[dat$sim_rate == 5e-4, grep('r.+rate_high', colnames(dat))] <- dat[dat$sim_rate == 5e-4, grep('r.+rate_high', colnames(dat))]  * 4
...
d_clock_med <- dat[dat$sim_rate == 0.0005 & dat$sd_rate == 0 , ]
