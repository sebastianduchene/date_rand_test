...
# Select the number of clocks with the variable k in the following line

k=1 # select k=2, or k=3 for two or three clocks, respectively.

# To run the simulations, open R and type:
#source("path to this file")
# Make sure phangorn and geiger are installed
